...
This project handles content-library integrations that may use private Airtable and Karakeep credentials.
...
- Use environment variables for Airtable and Karakeep configuration.
